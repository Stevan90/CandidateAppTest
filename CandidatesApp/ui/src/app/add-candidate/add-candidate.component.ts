...
export class AddCandidateComponent implements OnInit {
  ...
  constructor(private router: Router, private service: CandidateMasterService) { 
  }
  ...
  AddCandidate() {
    if (this.addCandidateForm.valid) {
      this.service.UpdateCandidate<ResponseModel>(this.addCandidateForm.value).subscribe(item => {
        this.respdata = item;
